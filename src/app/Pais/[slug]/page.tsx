    ...
    <>
      <Box sx={{ flexGrow: 1 }}>
        ...
        <Tabs defaultValue={sector || "frutas"} className="m-4">
          <TabsList className="grid h-auto w-auto grid-cols-1 grid-rows-5 lg:flex lg:max-w-[687px] lg:grid-cols-none lg:grid-rows-none lg:justify-start">
            <TabsTrigger value="frutas">Frutas Frescas</TabsTrigger>
            <TabsTrigger value="flor">Florícola</TabsTrigger>
